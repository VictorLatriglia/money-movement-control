...
export class AuthorizationService {
    ...
    public authorizationGet(phoneNumber?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/Authorization`,
            {
    ...
    public authorizationPost(xUserPhone: string, otp: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (otp !== undefined && otp !== null) {
            queryParameters = queryParameters.set('otp', <any>otp);
        }

        let headers = this.defaultHeaders;
        if (xUserPhone !== undefined && xUserPhone !== null) {
            headers = headers.set('X-User-Phone', String(xUserPhone));
        }
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/Authorization`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
